...
export SUBNET=$SUBNET_PREFIX.0.1.0/24
...
maas admin subnet update $SUBNET gateway_ip=$SUBNET_PREFIX.0.1.1
maas admin ipranges create type=dynamic start_ip=$SUBNET_PREFIX.0.1.200 end_ip=$SUBNET_PREFIX.0.1.254
